  ...
  <div className="space-y-4 text-gray-800 dark:text-slate-200">
    <ol className="list-inside list-decimal space-y-5">
      <li className="flex items-start">
        <Settings className="mr-4 mt-1 h-6 w-6 flex-shrink-0 text-indigo-600 dark:text-indigo-400" />
        <div>
          <strong className="text-gray-900 dark:text-slate-100">
            Configure Visualization Controls
          </strong>
          <ul className="mt-2 list-outside list-disc space-y-1.5 pl-5 text-gray-700 dark:text-slate-300">
            <li>
      ...
      <li className="flex items-start">
        <MousePointerClick className="mr-4 mt-1 h-6 w-6 flex-shrink-0 text-indigo-600 dark:text-indigo-400" />
        <div>
          <strong className="text-gray-900 dark:text-slate-100">Interact with the Plot</strong>
          <ul className="mt-2 list-outside list-disc space-y-1.5 pl-5 text-gray-700 dark:text-slate-300">
            <li>
            ...
            <li>
              ...
              <ul className="mt-2 list-outside list-disc space-y-1 pl-7 text-gray-600 dark:text-slate-400">
                <li>
      ...
      <li className="flex items-start">
        <Maximize className="mr-4 mt-1 h-6 w-6 flex-shrink-0 text-indigo-600 dark:text-indigo-400" />
        <div>
          <strong className="text-gray-900 dark:text-slate-100">Adjust the Layout</strong>
          <ul className="mt-2 list-outside list-disc space-y-1.5 pl-5 text-gray-700 dark:text-slate-300">
            <li>
